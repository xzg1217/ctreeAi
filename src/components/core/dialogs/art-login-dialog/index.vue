<template>
  <a-modal v-model:open="visible" title="" :footer="null" :closable="true" :mask-closable="true" width="500px" centered>
    <div class="flex justify-center flex-col w-full mt-10!">
      <h1 class="text-text-primary-1 text-[32px] font-semibold! mb-[8px] text-center font-poppins leading-[36px]">登录 </h1>
      <div class="text-[16px] leading-[20px] text-text-primary-3 text-center"
        >登录即可每天获得<div class="inline-block font-bold text-[18px] leading-[24px] relative text-text-primary-1">
      ...
      <div class="relative overflow-hidden">
          ...
          <div class="vcomp-phone">
            <div class="content h-full flex flex-col md:h-auto md:block phone-view">
              <div class="flex flex-col flex-1"
                ><a-button type="text" class="back self-start gap-[4px] flex! items-center" @click="showPhoneLogin = false">
                ...
                ><a-button type="button" class="ant-btn css-9c7804 ant-btn-primary ant-btn-block" disabled="" style="border-radius: 12px"
              ...
              <div class="pt-[20px] pb-[10px] text-center w-full md:hidden">
                <div class="text-[14px] flex-center gap-[4px] text-center"
                  ><svg xmlns="http://www.w3.org/2000/svg" width="17" height="17" fill="none" viewBox="0 0 17 17" class="inline-block">
                    <path
                      fill="#000"
                      fill-opacity="0.96"
                      fill-rule="evenodd"
                      ...
                      clip-rule="evenodd"
                    ></path>
                    <path fill="#6128FF" d="M12 7.458a4.542 4.542 0 1 0 0 9.084 4.542 4.542 0 0 0 0-9.084"></path>
                    <path
                      fill="#fff"
                      fill-rule="evenodd"
        ...
        <div class="relative w-full px-[30px] mb-[32px] mt-[32px]" v-show="!showPhoneLogin">
          <div class="px-4 py-3 flex justify-center text-text-primary-1 bg-color-grey-fill2-normal rounded-[8px]">
            <div class="flex-1 text-center">
              <div class="flex justify-center items-center gap-[4px] text-[16px] font-bold leading-5"><span>2025</span> </div>
              <div class="text-[12px] leading-[18px] text-text-primary-2">Chrome 编辑推荐</div>
            </div>
            <div class="flex-1 text-center">
              <div class="flex justify-center items-center gap-[4px] text-[16px] font-bold leading-5">100K+</div>
              <div class="text-[12px] leading-[18px] text-text-primary-2">5星好评</div>
            </div>
            <div class="flex-1 text-center">
              <div class="flex justify-center items-center gap-[4px] text-[16px] font-bold leading-5">10M+</div>
          ...
          >
            <div class="col-[icon] relative z-[5] text-white"
              ><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" width="20">
                ...
                ></path></svg
            ></div>
            <div class="col-[text] relative z-[5] cursor-pointer font-semibold text-[20px] text-white">使用手机登录</div>
            ...
            <div class="col-[icon] relative z-[5]"><img width="20" alt="" src="/src/assets/icons/google.svg" /></div>
            <div class="col-[text] relative z-[5] cursor-pointer font-semibold text-[20px] text-[#000000D1]">使用Google登录 </div>
            <div
            ...
            <div class="col-[icon] relative z-[5]"
              ><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" width="20">
                ...
                ></path></svg
            ></div>
            <div class="col-[text] relative z-[5] cursor-pointer font-semibold text-[20px] text-[#000000D1]">使用Apple登录 </div>
            <div
              class="col-[main] absolute inset-0 border border-[rgba(114,118,139,.32)] rounded-[12px] transition-colors cursor-pointer hover:bg-[#00000008] text-[#000000D1] bg-transparent"
        ...
        <div class="text-center mt-[40px] leading-5"
          >还没有账号？
          <button class="inline-block cursor-pointer font-[700] text-[#7450FF]! bg-transparent border-none p-0 m-0 outline-none"
            >创建一个帐户</button
          >
        </div>
      </div>
      <div class="mt-[40px] py-[16px] text-center text-color-text-primary-4! bg-color-grey-fill2-normal w-full mb:px-[12px]">
        <div class="text-[14px] flex-center gap-[4px] text-center"
          ><svg xmlns="http://www.w3.org/2000/svg" width="17" height="17" fill="none" viewBox="0 0 17 17">
            <path
              ...
              clip-rule="evenodd"
            ></path>
            <path fill="#787A94" d="M12 7.457a4.542 4.542 0 1 0 0 9.083 4.542 4.542 0 0 0 0-9.083"></path>
            <path
              fill="#fff"
              fill-rule="evenodd"
