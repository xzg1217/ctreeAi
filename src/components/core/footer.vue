    ...
    <div class="flex justify-between gap-6 max-w-[1400px] mx-auto px-8 box-border flex-wrap">
      <div class="flex flex-col max-w-[320px] md:max-w-[320px] w-full"
        ><svg width="190" height="40" viewBox="0 0 190 40" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <defs>
            <linearGradient id="LogoWhite_svg__a" x1="37.013" y1="38.924" x2="3.578" y2="7.332" gradientUnits="userSpaceOnUse">
            ...
            <linearGradient id="LogoWhite_svg__b" x1="37.013" y1="38.924" x2="3.578" y2="7.332" gradientUnits="userSpaceOnUse">
              <stop stop-color="#32C5FF"></stop>
              <stop offset="0.25" stop-color="#5666F5"></stop>
              <stop offset="0.524" stop-color="#8A57EA"></stop>
              <stop offset="0.821" stop-color="#EB35CE"></stop>
          ...
          ><a
            ...
            ><svg width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
              <g clip-path="url(#Email_svg__a)" fill="#DCDFF9" fill-opacity="0.92">
                ...
                ></path>
                <path d="M0 3.168v-.621a1.01 1.01 0 0 1 1.01-1.01h11.983a1.01 1.01 0 0 1 1.01 1.01v.621L7 9.202z"></path>
              </g>
              <defs>
                ...
                <li class="flex items-center gap-2"
                  ...
                  ><span
                    ><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                      ...
                      ></path>
                      <defs>
                        <linearGradient id="hot_svg__a" x1="10" y1="1.066" x2="10" y2="19.082" gradientUnits="userSpaceOnUse">
                          <stop stop-color="#ED6557"></stop>
                          <stop offset="1" stop-color="#E55749"></stop>
                        </linearGradient>
                        <linearGradient id="hot_svg__b" x1="9.981" y1="7.469" x2="9.981" y2="16.732" gradientUnits="userSpaceOnUse">
          ...
          <div class="flex gap-10">
            <div class="text-sm">
              <ul class="flex flex-col gap-4">
                ...
                <li
                  ><a target="_self" class="text-(--art-text-muted) hover:text-white" href="/zh-CN/invite">{{
                    t('home.footer.bottomLinks.invite')
                  }}</a>
                </li>
              </ul>
            </div>
      ...
      <div class="flex flex-col justify-center items-center mt-[52px] relative w-full"
        ...
        >
          ...
          ></path>
          <path d="M430.913 130.216v292.757h-78.069V130.216z" stroke="url(#Sider_svg__c)" stroke-width="4" mask="url(#Sider_svg__b)"></path>
          <path
