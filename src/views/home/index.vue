  ...
  <div class="home">
    ...
    <div class="relative w-[100vw] bg-grey-layer3-reserve text-white! pt-10 pb-[18px] bg-[#0C0D19]">
      <div class="flex justify-between gap-6 max-w-[1400px] mx-auto px-8 box-border flex-wrap">
        <div class="flex flex-col max-w-[320px] md:max-w-[320px] w-full"
          ><svg
            width="190"
            height="40"
            viewBox="0 0 190 40"
            ...
            ><a
              ...
              >
                <g clip-path="url(#Email_svg__a)" fill="#DCDFF9" fill-opacity="0.92">
                  ...
                  ></path>
                  <path
                    d="M0 3.168v-.621a1.01 1.01 0 0 1 1.01-1.01h11.983a1.01 1.01 0 0 1 1.01 1.01v.621L7 9.202z"
                  ></path>
                </g>
                <defs>
        ...
        <div class="flex gap-[60px] text-white flex-wrap">
          <div>
            <div class="text-base font-medium pb-4 border-b border-[rgba(214,218,255,0.10)] mb-4">{{
              t('home.footer.categories.products')
            }}</div>
              ...
              <div class="text-sm">
                ...
                <ul class="flex flex-col gap-y-4 gap-x-4">
                  <li class="flex items-center gap-2"
                    ><a
                      class="text-(--art-text-muted) hover:text-white"
                      title=""
                      href="/zh-CN/extensions"
                      >{{ t('home.footer.applications.extension') }}</a
                    ></li
                  >
                  <li class="flex items-center gap-2"
                    ><a
                  ...
                  <li class="flex items-center gap-2"
                    ><a
                      class="text-(--art-text-muted) hover:text-white"
                      title=""
                      href="/zh-CN/apps/android"
                      >{{ t('home.platforms.android') }}</a
                    ></li
                  >
                  <li class="flex items-center gap-2"
                    ><a
                  ...
                  <li class="flex items-center gap-2"
                    ><a
                      class="text-(--art-text-muted) hover:text-white"
                      title=""
                      href="/zh-CN/apps/windows"
                      >{{ t('home.platforms.windows') }}</a
                    ></li
                  >
                </ul>
              </div>
                ...
                <ul class="flex-col grid grid-cols-2 gap-4">
                  <li class="flex items-center gap-2"
                    ><a
                      ...
                      title=""
                      href="/wisebase"
                      >{{ t('home.footer.wisebase.wisebase') }}</a
                    ></li
                  >
                  <li class="flex items-center gap-2"
                    ><a
                      ...
                      title=""
                      href="/wisebase/deep-research"
                      >{{ t('home.footer.wisebase.deepResearch') }}</a
                    ></li
                  >
                  <li class="flex items-center gap-2"
                    ><a
                      class="text-(--art-text-muted) hover:text-white"
                      title=""
                      href="/wisebase/scholar-research"
                      >{{ t('home.footer.wisebase.scholarResearch') }}</a
                    ></li
                  >
                  <li class="flex items-center gap-2"
                    ><a
                      class="text-(--art-text-muted) hover:text-white"
                      title=""
                      href="/wisebase/math-solver"
                      >{{ t('home.footer.wisebase.mathSolver') }}</a
                    ></li
                  >
                  <li class="flex items-center gap-2"
                    ><a
                      ...
                      title="Rec Note"
                      href="/zh-CN/rec-note"
                      >{{ t('home.footer.wisebase.recNote') }}</a
                    ><span class="px-1 font-[600]! text-[11px] text-white bg-red-400 rounded-[4px]"
                      >New</span
                    >
                  </li>
                  <li class="flex items-center gap-2"
                    ><a
                      class="text-(--art-text-muted) hover:text-white"
                      title=""
                      href="/wisebase/audio-to-text"
                      >{{ t('home.footer.wisebase.audioToText') }}</a
                    ></li
                  >
                  <li class="flex items-center gap-2"
                    ><a
                      class="text-(--art-text-muted) hover:text-white"
                      title=""
                      href="/wisebase/gamification"
                      >{{ t('home.footer.wisebase.gamifiedLearning') }}</a
                    ></li
                  >
                  <li class="flex items-center gap-2"
                    ><a
                      class="text-(--art-text-muted) hover:text-white"
                      title=""
                      href="/wisebase/interactive-reading"
                      >{{ t('home.footer.wisebase.interactiveReading') }}</a
                    ></li
                  >
                  <li class="flex items-center gap-2"
                    ><a
                      ...
                      title=""
                      href="/zh-CN/chatpdf"
                      >{{ t('home.footer.wisebase.chatpdf') }}</a
                    ></li
                  >
                </ul>
              </div>
                ...
                <ul class="flex-col grid grid-cols-2 gap-4">
                  <li class="flex items-center gap-2"
                    ><a
                      class="text-(--art-text-muted) hover:text-white"
                      title=""
                      href="/agents/web-creator"
                      >{{ t('home.footer.tools.webCreator') }}</a
                    ><span class="px-1 font-[600]! text-[11px] text-white bg-red-400 rounded-[4px]"
                      >New</span
                    >
                  </li>
                  <li class="flex items-center gap-2"
                    ><a
                      class="text-(--art-text-muted) hover:text-white"
                      title=""
                      href="/agents/ai-slides"
                      >{{ t('home.footer.tools.aiSlides') }}</a
                    ><span class="px-1 font-[600]! text-[11px] text-white bg-red-400 rounded-[4px]"
                      >New</span
                    >
                  </li>
                  <li class="flex items-center gap-2"
                    ><a
                      ...
                      >{{ t('home.footer.tools.aiWriter') }}</a
                    ></li
                  >
                  <li class="flex items-center gap-2"
                    ><a
                      class="text-(--art-text-muted) hover:text-white"
                      title=""
                      href="/zh-CN/create/video/ai-video-shortener"
                      >{{ t('home.footer.tools.videoShortener') }}</a
                    ></li
                  >
                  <li class="flex items-center gap-2"
                    ><a
                      class="text-(--art-text-muted) hover:text-white"
                      title=""
                      href="/zh-CN/create/video/sora-video-downloader"
                      >{{ t('home.footer.bottomLinks.soraVideoDownloader') }}</a
                    ></li
                  >
                  <li class="flex items-center gap-2"
                    ><a
                      class="text-(--art-text-muted) hover:text-white"
                      title=""
                      href="/zh-CN/create/image/nano-banana-ai-image-generator"
                      >{{ t('home.footer.bottomLinks.nanoBanana') }}</a
                    ><span
                      ><svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="20"
                  ...
                  <li class="flex items-center gap-2"
                    ><a
                      class="text-(--art-text-muted) hover:text-white"
                      title=""
                      href="/zh-CN/create/image/ai-image-generator"
                      >{{ t('home.footer.bottomLinks.aiImageGenerator') }}</a
                    ></li
                  >
                  <li class="flex items-center gap-2"
                    ><a
                      class="text-(--art-text-muted) hover:text-white"
                      title=""
                      href="/zh-CN/create/image/italian-brainrot-generator"
                      >{{ t('home.footer.bottomLinks.italianBrainrotGenerator') }}</a
                    ></li
                  >
                  <li class="flex items-center gap-2"
                    ><a
                      class="text-(--art-text-muted) hover:text-white"
                      title=""
                      href="/zh-CN/create/image/background-remover"
                      >{{ t('home.footer.bottomLinks.backgroundRemover') }}</a
                    ></li
                  >
                  <li class="flex items-center gap-2"
                    ><a
                      class="text-(--art-text-muted) hover:text-white"
                      title=""
                      href="/zh-CN/create/image/photo-background-changer"
                      >{{ t('home.footer.bottomLinks.photoBackgroundChanger') }}</a
                    ></li
                  >
                  <li class="flex items-center gap-2"
                    ><a
                      class="text-(--art-text-muted) hover:text-white"
                      title=""
                      href="/zh-CN/create/image/photo-eraser"
                      >{{ t('home.footer.bottomLinks.photoEraser') }}</a
                    ></li
                  >
                  <li class="flex items-center gap-2"
                    ><a
                      class="text-(--art-text-muted) hover:text-white"
                      title=""
                      href="/zh-CN/create/image/text-remover"
                      >{{ t('home.footer.bottomLinks.textRemover') }}</a
                    ></li
                  >
                  <li class="flex items-center gap-2"
                    ><a
                      class="text-(--art-text-muted) hover:text-white"
                      title=""
                      href="/zh-CN/create/image/inpaint"
                      >{{ t('home.footer.not-[]:bottomLinks.inpaint') }}</a
                    ></li
                  >
                  <li class="flex items-center gap-2"
                    ><a
                      class="text-(--art-text-muted) hover:text-white"
                      title=""
                      href="/zh-CN/create/image/image-upscaler"
                      >{{ t('home.footer.bottomLinks.imageUpscaler') }}</a
                    ></li
                  >
                  <li class="flex items-center gap-2"
                    ><a
                      class="text-(--art-text-muted) hover:text-white"
                      title=""
                      href="/zh-CN/translator/text-translator"
                      >{{ t('home.footer.bottomLinks.textTranslator') }}</a
                    ></li
                  >
                  <li class="flex items-center gap-2"
                    ><a
                      class="text-(--art-text-muted) hover:text-white"
                      title=""
                      href="/zh-CN/translator/image-translator"
                      >{{ t('home.footer.bottomLinks.imageTranslator') }}</a
                    ></li
                  >
                  <li class="flex items-center gap-2"
                    ><a
                      class="text-(--art-text-muted) hover:text-white"
                      title=""
                      href="/zh-CN/translator/pdf-translator"
                      >{{ t('home.footer.bottomLinks.pdfTranslator') }}</a
                    ></li
                  >
                </ul>
              </div>
          ...
          <div>
            <div class="text-base font-medium pb-4 border-b border-[rgba(214,218,255,0.10)] mb-4">{{
              t('home.footer.bottomLinks.sider')
            }}</div>
                ...
                <ul class="flex flex-col gap-4">
                  <li
                    ><a
                      ...
                      class="text-(--art-text-muted) hover:text-white"
                      href="/zh-CN/contact"
                      >{{ t('home.footer.bottomLinks.contact') }}</a
                    >
                  </li>
                  <li
                    ><a
                      target="_self"
                      class="text-(--art-text-muted) hover:text-white"
                      href="/zh-CN/help-center"
                      >{{ t('home.footer.bottomLinks.helpCenter') }}</a
                    ></li
                  >
                  <li
                    ><a
                      ...
                      class="text-(--art-text-muted) hover:text-white"
                      href="/zh-CN/download"
                      >{{ t('home.footer.bottomLinks.download') }}</a
                    >
                  </li>
                  <li
                    ><a
                      ...
                      class="text-(--art-text-muted) hover:text-white"
                      href="/zh-CN/pricing"
                      >{{ t('home.footer.bottomLinks.pricing') }}</a
                    >
                  </li>
                  <li
                    ><a
                      target="_self"
                      class="text-(--art-text-muted) hover:text-white"
                      href="/zh-CN/whats-new"
                      >{{ t('home.footer.bottomLinks.whatsNew') }}</a
                    >
                  </li>
                  <li
                    ><a
                      ...
                      class="text-(--art-text-muted) hover:text-white"
                      href="/zh-CN/blog"
                      >{{ t('home.footer.bottomLinks.blog') }}</a
                    ></li
                  >
                  <li
                    ><a
                      target="_blank"
                      class="text-(--art-text-muted) hover:text-white"
                      href="https://community.sider.ai/"
                      >{{ t('home.footer.bottomLinks.community') }}</a
                    ></li
                  >
                  <li
                    ><a
                      ...
                      class="text-(--art-text-muted) hover:text-white"
                      href="/zh-CN/partners"
                      >{{ t('home.footer.bottomLinks.partners') }}</a
                    >
                  </li>
                  <li
                    ><a
                      target="_self"
                      class="text-(--art-text-muted) hover:text-white"
                      href="/zh-CN/affiliate"
                      >{{ t('home.footer.bottomLinks.affiliate') }}</a
                    >
                  </li>
                  <li
                    ><a
                      ...
                      class="text-(--art-text-muted) hover:text-white"
                      href="/zh-CN/invite"
                      >{{ t('home.footer.bottomLinks.invite') }}</a
                    >
                  </li>
                </ul>
              </div>
        ...
        <div class="flex flex-col justify-center items-center mt-[52px] relative w-full"
          ><svg
            width="1405"
            height="298"
            viewBox="0 0 1405 298"
            fill="none"
            xmlns="http://www.w3.org/2000/svg"
          ...
          >
            ...
            <path
              ...
              stroke="url(#Sider_svg__a)"
              stroke-width="4"
              mask="url(#Sider_svg__b)"
            ></path>
            <path
              d="M430.913 130.216v292.757h-78.069V130.216z"
              stroke="url(#Sider_svg__c)"
              stroke-width="4"
              mask="url(#Sider_svg__b)"
            ></path>
            <path
          ...
          <div class="flex justify-start sm:!justify-between items-center w-full flex-wrap gap-2">
            <div
              class="text-sm text-text-white-3 flex gap-[10px] flex-wrap justify-start order-1 sm:order-none"
            >
              ©<!-- -->2025<!-- -->
              <!-- -->版权所有<div class="bg-[rgba(214,218,255,0.10)] w-[1px] h-[20px]"></div
              ><a class="hover:text-text-white-1" href="/zh-CN/policies/terms">{{
                t('home.footer.termsOfUse')
              }}</a>

              <div class="bg-[rgba(214,218,255,0.10)] w-[1px] h-[20px]"></div
              ><a class="hover:text-text-white-1" href="/zh-CN/policies/privacy">{{
