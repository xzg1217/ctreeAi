        ...
        ><div class="relative w-full h-full flex flex-col bg-bg2 rounded-[12px] p-[8px] select-none"
          ><div
            ...
            ><div class="flex flex-col items-center text-center"
              ...
              ><p class="text-blackText3 text-[12px]">每次使用扣除 <span class="text-primary5">3</span> 高级积分</p></div
            ></div
          ><div class="mt-[16px]"
            ><div class="text-center space-x-[15px] lg:space-x-[45px]"
              ><img
                ...
                data-nimg="1"
                class="inline-block w-[25%] max-w-[236px] rounded-[8px]"
                src="@/assets/img/icons/inpaint3.webp"
                style="color: transparent" /></div></div></div></div
      ><div class="mt-[12px] flex justify-center"
        ><div class="w-full flex lg:items-center flex-col lg:flex-row! gap-[12px] lg:gap-[24px]"
            ...
            ><div class="flex items-center gap-[16px]"
              ><div class="relative bg-bg2 p-[4px] rounded-[8px]"
                ...
                ><div class="relative flex z-[1]"
                  ><button
                    type="button"
                    disabled=""
                    class="flex items-center justify-center p-[6px] rounded-[8px] bg-transparent disabled:bg-bg2 disabled:text-blackText4 text-primary cursor-default"
                  ...
                  ><button
                    type="button"
                    disabled=""
                    class="flex items-center justify-center p-[6px] rounded-[8px] bg-transparent disabled:bg-bg2 disabled:text-blackText4 hover:text-primary"
                    ><svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path
                        fill-rule="evenodd"
                        clip-rule="evenodd"
              ...
              ><div class="rounded-[8px] bg-bg2 flex items-center gap-[12px]"
                ><a-slider
                  ...
                  class="w-[100px] sm:w-[140px] md:w-[180px]"
                  :min="20"
                  :max="120"
                  :value="72"
                  disabled
                ></a-slider></div></div></div
          ><div class="flex-1 flex items-center lg:max-w-[680px] gap-[12px]"
            ><div class="relative flex-1 text-blackText2">
              <textarea
                rows="1"
                placeholder="描述您希望标记区域如何被重新绘制"
                maxlength="1000"
                class="ant-input css-mkip61 ant-input-borderless w-full !min-h-[40px] p-[8px] !bg-[rgba(0,0,0,0.04)] text-[14px]! rounded-[4px]"
                style="overflow-y: hidden; resize: none; height: 38px; max-height: 60px"
              ></textarea
              ><div class="absolute bottom-[4px] right-[4px] text-[12px] text-blackText3 pointer-events-none">0 / 1000</div></div
